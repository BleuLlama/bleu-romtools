...
; ramsnoop patch
;
; $Id: pacsnoop.asm,v 1.2 2004/03/15 22:08:33 jerry Exp $ 

; 1.1 public release 1
; 1.2 skipped
; 1.3 bugfix with sustain-between-resets, fewer bugs
...
.org	0x37ff
	.ascii	"@@PAC@SNOOP@@V1%3@@@"

.org	0x3d24	; coin screen
	.ascii  "2004@UMLAUTLLAMA;COM"
;	.ascii  "@2004@YOYODYNE@PROP%"

.org	0x3d3f	; main screen
	.ascii  "2004@UMLAUTLLAMA;COM"
;	.ascii	"@2004@YOYODYNE@PROP%"
...
.rcpat0:
        ...
        rst     #8
        rst     #8
        ;rst    #8              ; for some reason this REALLY hoses things
